...
if(NOT DEFINED SIGNTOOL_CERT_HAS_UI)
    set(SIGNTOOL_CERT_HAS_UI "$ENV{SIGNTOOL_CERT_HAS_UI}")
endif()
...
if(WIN32)
    ...
    if(SIGNTOOL_SUBJECT_NAME)
        ...
        signtool_sign_files("${AMNEZIA_PACKAGE_DIR}/*.exe" "${SIGNTOOL_SUBJECT_NAME}" "${SIGNTOOL_CERT_HAS_UI}")
		signtool_sign_files("${AMNEZIA_PACKAGE_DIR}/*.dll" "${SIGNTOOL_SUBJECT_NAME}" "${SIGNTOOL_CERT_HAS_UI}")
    endif()
endif()
