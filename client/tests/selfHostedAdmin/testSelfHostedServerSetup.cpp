...
private:
    ...
    ServerCredentials getCredentialsFromEnv() {
        ...
        QString hostName = getEnvValue("SELF_HOSTED_SERVER_HOST_NAME");
        QString userName = getEnvValue("SELF_HOSTED_SERVER_USER_NAME");
        QString password = getEnvValue("SELF_HOSTED_SERVER_PASSWORD");
        QString portStr = getEnvValue("SELF_HOSTED_SERVER_SSH_PORT");
...
private slots:
    ...
    void testSelfHostedServerEmptyRecover() {
        ...
        serverConfig.description = m_coreController->m_serversRepository->nextAvailableServerName();
