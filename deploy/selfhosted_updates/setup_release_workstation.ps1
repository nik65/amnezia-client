...
param(
    ...
    [string] $AndroidNdkVersion = $(if ($env:ANDROID_NDK_VERSION) { $env:ANDROID_NDK_VERSION } else { "27.2.12479018" }),
...
function Write-EnvironmentFile {
    ...
    $content = @(
        ...
        "`$env:ANDROID_NDK_VERSION = $(Quote-PsSingle $AndroidNdkVersion)",
